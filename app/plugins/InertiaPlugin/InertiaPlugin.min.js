...
!(function (t, e) {
  ...
  function Z(t, e, r, i, n) {
    ...
    if (O(t)) {
      ...
      for (; u--; )
        (a = (o = e[u]) - t) < 0 && (a = -a), a < l && i <= o && o <= r && ((f = u), (l = a));
    return e[f];
  }
  ...
  function da(t, e, r, i) {
    if (e.linkedProps) {
      ...
      for (n = 0; n < f.length; n++)
        (a = e[(o = f[n])]) &&
          ((s = N(a.velocity) ? a.velocity : (c = c || B(t)) && c.isTracking(o) ? c.get(o) : 0),
    ...
    D = {
      ...
      init: function init(t, e, r, i, n) {
                ...
                for (a in ((d = da(t, m, k, T)), m))
                  U[a] ||
                    ...
                    O(s) &&
                      ...
                      'end' in s &&
                        ((s = $(s, d && a in d ? d : l, s.max, s.min, a, m.radius, u)),
                        o && (j === e && (j = m = Y(e)), (m[a] = X(s, m[a], 'end')))),
                      'max' in s && l > +s.max + 1e-10
                        ? ((v = s.unitFactor || V.unitFactors[a] || 1),
                          (p =
                            (f > s.max && s.min !== s.max) || (-15 < u * v && u * v < 45)
                              ? i + 0.1 * (r - i)
                              : ba(f, s.max, u)) +
                            n <
                            y && (y = p + n))
                        : 'min' in s &&
                          ...
                          ((v = s.unitFactor || V.unitFactors[a] || 1),
                          (p =
                            (f < s.min && s.min !== s.max) || (-45 < u * v && u * v < 15)
                              ? i + 0.1 * (r - i)
                              : ba(f, s.min, u)) +
                            n <
                            y && (y = p + n)),
        ...
        for (a in ((e = j), (j = 0), (v = da(t, e, h, T)), e))
          U[a] ||
            ...
            O(s) &&
              ((p = c + l),
              'end' in s && (s = $(s, v && a in v ? v : p, s.max, s.min, a, e.radius, f)),
              'max' in s && +s.max < p
      ...
      render: function render(t, e) {
        ...
        if ((t = k(e.tween._time / e.tween._dur)) || !w())
          for (; r; )
            r.set(r.t, r.p, W(r.s + r.c1 * t + r.c2 * t * t) + r.u, r.d, t), (r = r._next);
